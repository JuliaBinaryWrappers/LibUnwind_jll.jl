...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LibUnwind_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("745a5e78-f969-53e9-954f-d19f2f74f4e3"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LibUnwind", artifacts_toml) for e in artifacts["LibUnwind"]]
...
if best_platform === nothing
    @debug("Unable to load LibUnwind; unsupported platform $(triplet(platform_key_abi()))")
else
